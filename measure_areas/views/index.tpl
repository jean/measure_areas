...
<body>
                    ...
                    <ul>
                        ...
                        <li>
                            <form action="measure" method="POST">
                                <input type="file" name="upload" class="btn btn-primary btn-lg wow fadeInLeft" data-wow-delay="0.2s" />
                                <input type="submit" href="https://mdbootstrap.com/material-design-for-bootstrap/" class="btn btn-default btn-lg wow fadeInRight"
    ...
    <div class="container">
        ...
        <section id="about" class="text-center wow fadeIn" data-wow-delay="0.2s">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Velit explicabo assumenda eligendi ex exercitationem
                harum deleniti quaerat beatae ducimus dolor voluptates magnam, reiciendis pariatur culpa tempore quibusdam
                quidem, saepe eius.</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Velit explicabo assumenda eligendi ex exercitationem
                harum deleniti quaerat beatae ducimus dolor voluptates magnam, reiciendis pariatur culpa tempore quibusdam
                quidem, saepe eius.</p>
    ...
    <footer class="page-footer center-on-small-only elegant-color-dark">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 ml-auto">
                    ...
                    <ul>
                        <li>
                            <a href="#!">Jeffs Bike Shop</a>
                        </li>
                        <li>
                            <a href="#!">Main Street Restaurant</a>
                        </li>
                        <li>
                            <a href="#!">Connect Groceries</a>
                        </li>
                        <li>
                            <a href="#!">White-To-Black Coffe Shop</a>
                        </li>
                    </ul>
                </div>
                <!--/.Second column-->
                ...
                <div class="col-lg-2 col-md-6 ml-auto">
                    ...
                    <ul>
                        <li>
                            <a href="#!">2016 Advertising Report</a>
                        </li>
                        <li>
                            <a href="#!">Best NY Agencies</a>
                        </li>
                        <li>
                            <a href="#!">Trends for 2017</a>
                        </li>
                        <li>
                            <a href="#!">World Advertisement Report</a>
                        </li>
                    </ul>
                </div>
                <!--/.Third column-->
        ...
        <div class="call-to-action">
            ...
            <ul>
                ...
                <li>
                    <a target="_blank" href="https://mdbootstrap.com/getting-started/" class="btn btn-info" rel="nofollow">Sign up!</a>
                </li>
                <li>
                    <a target="_blank" href="https://mdbootstrap.com/material-design-for-bootstrap/" class="btn btn-default" rel="nofollow">Learn more</a>
                </li>
            </ul>
        </div>
        <!--/.Call to action-->
